...
export default function LogoutModal({ openModal, setOpenModal }) {
  ...
  return ReactDom.createPortal(
    !!openModal && (
      ...
      >
        <div className="bg-slate-100 shadow-lg w-1/4 py-6 rounded-md relative">
          <div className="text-center">
            ...
            {!loading && (
              <button
                onClick={logout}
                className="py-1.5 px-3 m-1 text-center bg-red-500 rounded-md text-white hidden lg:inline-block"
              >
                Confirm
              </button>
            )}
            ...
            {!!loading && (
              <button className="py-1.5 px-3 m-1 text-center bg-red-500 rounded-md text-white hidden lg:inline-block">
                <svg
                  aria-hidden="true"
                  role="status"
